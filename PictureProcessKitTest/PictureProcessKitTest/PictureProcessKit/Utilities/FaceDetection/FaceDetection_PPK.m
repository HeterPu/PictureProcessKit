...
@implementation Face_PPK
@end


@interface FaceDetection_PPK ()
...
@implementation FaceDetection_PPK

#pragma mark - Singleton
+ (instancetype)sharedInstance
{
    static FaceDetection_PPK *instance = nil;
...
- (NSArray *)detectFacesOnImage:(UIImage *)image
{
  ...
  for(CIFaceFeature* faceFeature in features)
  {
    ...
    Face_PPK *face = [[Face_PPK alloc] init];
...
- (UIImage *)transformFace:(Face_PPK *)face1 intoFace:(Face_PPK *)face2
{
